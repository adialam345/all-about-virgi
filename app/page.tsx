...
export default function Home() {
  ...
  const onTouchEnd = () => {
    if (!isTransitioning) {
      ...
      const tabs = ['about', 'likes', 'dislikes', 'tags', 'funfacts']
        ...
        <div className="w-full sticky top-[4.5rem] z-10 bg-background/80 backdrop-blur-md">
          <div className="w-full max-w-[90rem] mx-auto px-4">
            <div className="md:block flex justify-center">
              <TabsList className="h-12 bg-muted/50 p-1 md:w-full md:grid md:grid-cols-5 overflow-x-auto no-scrollbar">
                <TabsTrigger 
                  value="about"
                  className="rounded px-4 data-[state=active]:bg-background transition-all duration-200 data-[state=active]:scale-[0.97] hover:bg-background/50"
                >
                  About
                </TabsTrigger>
                <TabsTrigger 
